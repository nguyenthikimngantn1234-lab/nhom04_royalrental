...
// --- Component phụ - ĐÃ CẬP NHẬT FONT MONTSERRAT ---
const ContactInput = ({ label, placeholder, name, type = "text", required = false }: any) => (
  <div className="flex flex-col w-full" style={{ marginBottom: '32px', fontFamily: "var(--font-montserrat), sans-serif" }}>
    ...
    <input
      ...
      style={{ width: '100%', height: '56px' , padding: '0 16px', fontFamily: "var(--font-montserrat), sans-serif"}}
      required={required}
    />
  </div>
);
...
const ContactTextarea = ({ label, placeholder, name, required = false }: any) => (
  <div className="flex flex-col w-full" style={{ marginBottom: '12px', fontFamily: "var(--font-montserrat), sans-serif" }}>
    <label className="text-[22px] font-bold text-[#1e1535]" style={{ marginBottom: "12px", display: "block" }}>
      {label} {required && <span className="text-[#FF4D4D] font-bold">*</span>}
    </label>
    <textarea
...
const InfoCard = ({ title, detail }: { title: string; detail: React.ReactNode }) => (
  <div className="flex flex-col gap-4 contact-info-card" style={{ fontFamily: "var(--font-montserrat), sans-serif" }}>
    <h3 className="text-[24px] font-black text-[#1e1535] uppercase tracking-tight">{title}</h3>
...
export default function ContactPage() {
  ...
  return (
    <>
      ...
      <style jsx global>{`
        /* Đảm bảo font Montserrat được ép vào toàn bộ trang liên hệ */
      ...
      <main className="contact-page-wrapper w-full bg-white overflow-x-hidden mt-[107px]" style={{ fontFamily: "var(--font-montserrat), sans-serif" }}>
        ...
        <div className="w-full bg-white contact-section-height h-[205px] flex items-center">
          <div className="max-w-[1440px] w-full mx-auto contact-container-px">
            <div className="max-w-[800px]">
              <h1 className="contact-title-h1 text-[54px] font-black text-[#1e1535] leading-none mb-5 uppercase tracking-tight">LIÊN HỆ</h1>
              <p className="text-[20px] text-[#6B7280] leading-relaxed font-medium">
        ...
        <div className="w-full bg-[#F5F3FF] contact-section-height h-[205px] flex items-center border-y border-[#E5E0FF]">
          <div className="max-w-[1440px] w-full mx-auto contact-container-px contact-info-grid">
            ...
            <InfoCard title="Giờ Làm Việc" detail={
              <p className="text-[#1e1535] font-medium">
        ...
        <div className="w-full bg-white py-28">
          <div className="max-w-[1440px] mx-auto contact-container-px contact-form-flex">
            ...
            >
              <iframe
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3918.485398611095!2d106.7693381!3d10.8506324!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x31752763f238a333%3A0x81efb3b3b0a66f6!2zMSBWw7UgVsSDbiBOZ8OibiwgTG5uaCBDaGnhu4N1LCBUaOG7pyDEkOG7YywgSOG7SBDaMOtIE1pbmgsIFZp4buHdCBOYW0!5e0!3m2!1svi!2s!4v1711234567890"
                width="100%"
                height="100%"
                style={{ border: 0 }}
