...
export default function AccountPage() {
  ...
  const [userData] = useState({
    fullName: "Kim Ngân", // Cô đổi tên cho đúng chủ nhân nhé
        ...
        return (
          <div className="animate-in fade-in slide-in-from-bottom-4 duration-500">
            ...
            <div className="flex items-center gap-12 mb-10">
              ...
              <div>
                <h3 className="text-[34px] font-bold text-[#1e1535] m-0">{userData.fullName}</h3>
      ...
      case "orders":
        return (
          <div className="flex flex-col items-center justify-center py-20 animate-in fade-in zoom-in-95 duration-500">
            ...
            <h2 className="text-[30px] font-bold text-[#1e1535]">Bạn chưa có đơn hàng nào</h2>
            <p className="text-[#6B7280] mt-2 text-[20px]">Hãy tiếp tục khám phá các sản phẩm tại Velixora nhé!</p>
          </div>
        );
      case "wishlist":
        return (
          <div className="flex flex-col items-center justify-center py-20 animate-in fade-in zoom-in-95 duration-500">
            ...
            <h2 className="text-[30px] font-bold text-[#1e1535]">Danh sách yêu thích trống</h2>
            <p className="text-[#6B7280] mt-2 text-[20px]">Lưu lại những món đồ bạn ưng ý để mua sau.</p>
          </div>
        );
      default:
  ...
  return (
    <>
      <Header />
      <main className="w-full min-h-screen bg-[#FDFDFF] pt-[130px] pb-24" style={{ fontFamily: "'Times New Roman', Times, serif" }}>
        <div className="max-w-[1280px] mx-auto px-8 lg:px-[80px]">
          
          <div className="mb-[80px]">
            <h1 className="text-[40px] font-black text-[#1e1535] uppercase m-0 tracking-tighter">Tài khoản của tôi</h1>
            <p className="text-[#6B7280] text-[24px] mt-2 font-medium opacity-80">Quản lý thông tin cá nhân và hành trình mua sắm của bạn</p>
          </div>

          <div className="flex flex-row items-start w-full">
            <div
              className="w-[340px] shrink-0 bg-white rounded-[26px] p-8 shadow-[0_12px_40px_rgba(122,51,242,0.15)] border border-[#7a33f2]/30"
            ...
            <div className="flex-1 min-w-0 bg-white rounded-[26px] px-[60px] py-[50px] shadow-[0_8px_30px_rgba(0,0,0,0.04)] border border-gray-200">
              {renderContent()}
            </div>
          </div>
        </div>
