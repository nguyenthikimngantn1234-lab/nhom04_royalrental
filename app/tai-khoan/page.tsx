...
export default function AccountPage() {
          ...
          <div className="animate-in fade-in slide-in-from-bottom-4 duration-500">
            ...
            <div className="flex items-center gap-12 mb-10 acc-avatar-row">
              ...
              <div>
                ...
                <p className="text-[#6B7280] text-[20px] mt-1.5 font-medium">Thành viên từ tháng 4/2026</p>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-x-10 gap-y-6 mb-10">
              <div className="flex flex-col gap-2.5">
                ...
                <input type="text" defaultValue={userData.fullName} style={{ fontFamily: 'var(--font-montserrat), sans-serif' }} className="w-full h-[54px] bg-[#F9F8FF] text-[#4B5563] rounded-[14px] px-5 outline-none border border-transparent focus:border-[#7a33f2] transition-all text-[20px] font-medium" />
              </div>
              <div className="flex flex-col gap-2.5">
                <label className="text-[22px] font-bold text-black">Email</label>
                <input type="email" defaultValue={userData.email} style={{ fontFamily: 'var(--font-montserrat), sans-serif' }} className="w-full h-[54px] bg-[#F9F8FF] text-[#4B5563] rounded-[14px] px-5 outline-none border border-transparent focus:border-[#7a33f2] transition-all text-[21px] font-medium" />
              </div>
              <div className="flex flex-col gap-2.5">
                <label className="text-[22px] font-bold text-black">Số điện thoại</label>
                <input type="text" defaultValue={userData.phone} style={{ fontFamily: 'var(--font-montserrat), sans-serif' }} className="w-full h-[54px] bg-[#F9F8FF] text-[#4B5563] rounded-[14px] px-5 outline-none border border-transparent focus:border-[#7a33f2] transition-all text-[20px] font-medium" />
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-x-10 gap-y-6 mb-8">
              <div className="flex flex-col gap-2.5">
                ...
                <input type="text" defaultValue={userData.city} style={{ fontFamily: 'var(--font-montserrat), sans-serif' }} className="w-full h-[54px] bg-[#F9F8FF] text-[#4B5563] rounded-[14px] px-5 outline-none border border-transparent focus:border-[#7a33f2] transition-all text-[20px] font-medium" />
              </div>
              <div className="flex flex-col gap-2.5">
                <label className="text-[22px] font-bold text-black">Quận/ Huyện</label>
                <input type="text" defaultValue="Thủ Đức" style={{ fontFamily: 'var(--font-montserrat), sans-serif' }} className="w-full h-[54px] bg-[#F9F8FF] text-[#4B5563] rounded-[14px] px-5 outline-none border border-transparent focus:border-[#7a33f2] transition-all text-[20px] font-medium" />
              </div>
            </div>
            <div className="flex flex-col gap-2.5">
              <label className="text-[22px] font-bold text-black">Địa chỉ cụ thể</label>
              <input type="text" defaultValue="Số 1 Võ Văn Ngân" style={{ fontFamily: 'var(--font-montserrat), sans-serif' }} className="w-full h-[54px] bg-[#F9F8FF] text-[#4B5563] rounded-[14px] px-5 outline-none border border-transparent focus:border-[#7a33f2] transition-all text-[20px] font-medium" />
            </div>
          </div>
        );
      case "orders":
        return (
          <div className="flex flex-col items-center justify-center py-20 animate-in fade-in zoom-in-95 duration-500">
            ...
            <p className="text-[#6B7280] mt-2 text-[20px] text-center font-medium">Hãy tiếp tục khám phá các sản phẩm tại Velixora nhé!</p>
          </div>
        );
      case "wishlist":
        return (
          <div className="flex flex-col items-center justify-center py-20 animate-in fade-in zoom-in-95 duration-500">
            ...
            <p className="text-[#6B7280] mt-2 text-[20px] text-center font-medium">Lưu lại những món đồ bạn ưng ý để mua sau.</p>
          </div>
        );
      default:
  ...
  return (
    <>
      ...
      <style jsx global>{`
        /* Ép font Montserrat cho toàn bộ các thành phần trong main */
        .acc-main-wrapper * {
        ...
        @media (max-width: 767px) {
          .acc-main-wrapper { padding-top: 100px !important; }
          .acc-header-section { margin-bottom: 40px !important; text-align: center; }
      ...
      <main className="acc-main-wrapper w-full min-h-screen bg-[#FDFDFF] pt-[130px] pb-24" style={{ fontFamily: 'var(--font-montserrat), sans-serif' }}>
        <div className="max-w-[1280px] mx-auto px-8 lg:px-[80px]">
          ...
          <div className="acc-header-section mb-[80px]">
            ...
            <p className="acc-header-p text-[#6B7280] text-[24px] mt-2 font-semibold opacity-80">Quản lý thông tin cá nhân và hành trình mua sắm của bạn</p>
          </div>

          <div className="acc-main-flex">
            {/* SIDEBAR MENU */}
            <div className="acc-sidebar bg-white rounded-[26px] p-8 shadow-[0_12px_40px_rgba(122,51,242,0.15)] border border-[#7a33f2]/30">
              <div className="flex flex-col">
                {menuItems.map((item) => (
                  <button
                    key={item.id}
                    onClick={() => setActiveTab(item.id)}
                    style={{ marginBottom: "32px", fontFamily: 'var(--font-montserrat), sans-serif' }}
                  ...
                  >
                    <item.icon className="w-[24px] h-[24px]" style={{ marginRight: "16px" }} />
