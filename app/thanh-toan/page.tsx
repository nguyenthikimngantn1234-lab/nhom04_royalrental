  ...
  return (
    <>
      ...
      <style jsx global>{`
        ...
        .checkout-right-col { width: 500px; }
        ...
        @media (max-width: 767px) {
          ...
          .checkout-card { padding: 30px 15px !important; border-radius: 24px !important; }
          .checkout-grid-2 { grid-template-columns: 1fr !important; gap: 20px !important; }
          .checkout-address-flex { flex-direction: column !important; gap: 15px !important; }
          .checkout-payment-qr-box { padding-left: 0 !important; flex-direction: column !important; align-items: center !important; text-align: center !important; }
          .summary-font-fix { font-size: 16px !important; }
          .total-font-fix { font-size: 30px !important; }
        }

        @media (min-width: 768px) and (max-width: 1279px) {
          .checkout-container { padding: 0 40px !important; }
      ...
      <main className="w-full min-h-screen bg-[#FDFDFF] pt-[150px] pb-24 text-[#1e1535]" style={{ fontFamily: "'Times New Roman', Times, serif" }}>
        ...
        <div className="checkout-container mx-auto max-w-[1440px]">
          ...
          <div className="checkout-h1" style={{ marginBottom: "48px", width: "100%" }}>
          ...
          <div className="checkout-layout">
            ...
            <div className="checkout-right-col" style={{ flexShrink: 0, backgroundColor: "white", borderRadius: "40px", padding: "40px", boxShadow: "0 8px 30px rgba(0,0,0,0.04)", border: "1px solid #E9E4FF", position: "sticky", top: "150px" }}>
              ...
              <div className="border-t-2 border-dashed border-[#F0EEFF] pt-8 space-y-5">
                <div className="flex justify-between summary-font-fix text-[18px] text-gray-600 font-medium">
                  <span>Tạm tính</span>
                  <span className="text-[#1e1535] font-bold">{subtotal.toLocaleString()}đ</span>
                </div>
                <div className="flex justify-between summary-font-fix text-[18px] text-[#7a33f2] font-medium">
                ...
                <div className="flex justify-between items-center pt-8 border-t border-[#F0EEFF]">
                  ...
                  <span className="total-font-fix text-[40px] font-black text-[#7a33f2] tracking-tighter leading-none m-0">{total.toLocaleString()}đ</span>
                </div>
              </div>
            </div>
            ...
            <div className="checkout-left-col flex flex-col gap-[40px]">
              
              <div className="checkout-card" style={{ backgroundColor: "white", borderRadius: "40px", padding: "48px", boxShadow: "0 8px 30px rgba(0,0,0,0.04)", border: "1px solid #E9E4FF" }}>
              ...
              <div className="checkout-card" style={{ backgroundColor: "white", borderRadius: "40px", padding: "48px", boxShadow: "0 8px 30px rgba(0,0,0,0.04)", border: "1px solid #E9E4FF" }}>
                ...
                <div style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
                  ...
                  <div onClick={() => setPaymentMethod("cod")} className="checkout-payment-item" style={{ display: "flex", alignItems: "center", gap: "24px", padding: "20px 32px", borderRadius: "24px", cursor: "pointer", backgroundColor: paymentMethod === "cod" ? "#F9F8FF" : "transparent" }}>
                    ...
                    <span className="font-bold text-[20px]">Thanh toán (COD)</span>
                  </div>
                  ...
                  <div style={{ display: "flex", flexDirection: "column", borderRadius: "24px", backgroundColor: paymentMethod === "bank" ? "#F9F8FF" : "transparent" }}>
                    <div onClick={() => setPaymentMethod("bank")} className="checkout-payment-item" style={{ display: "flex", alignItems: "center", gap: "24px", padding: "20px 32px", cursor: "pointer" }}>
                      ...
                      <span className="font-bold text-[20px]">Chuyển khoản Ngân hàng</span>
                    </div>
                    {paymentMethod === "bank" && (
                      <div className="animate-in fade-in slide-in-from-top-2 checkout-payment-qr-box" style={{ display: "flex", alignItems: "center", gap: "32px", paddingBottom: "32px", paddingRight: "32px", paddingLeft: "88px" }}>
                        ...
                        <div style={{ display: "flex", flexDirection: "column", gap: "10px" }}>
                          <span className="text-[#7a33f2] font-black text-[24px] leading-none">STK: 1234 5678</span>
                  ...
                  <div style={{ display: "flex", flexDirection: "column", borderRadius: "24px", backgroundColor: paymentMethod === "momo" ? "#F9F8FF" : "transparent" }}>
                    <div onClick={() => setPaymentMethod("momo")} className="checkout-payment-item" style={{ display: "flex", alignItems: "center", gap: "24px", padding: "20px 32px", cursor: "pointer" }}>
                      ...
                      <span className="font-bold text-[20px]">Ví điện tử MoMo</span>
                    </div>
                    {paymentMethod === "momo" && (
                      <div className="animate-in fade-in slide-in-from-top-2 checkout-payment-qr-box" style={{ display: "flex", alignItems: "center", gap: "32px", paddingBottom: "32px", paddingRight: "32px", paddingLeft: "88px" }}>
                        <div style={{ backgroundColor: "white", padding: "12px", borderRadius: "24px", border: "1px solid #E9E4FF", flexShrink: 0 }}>
